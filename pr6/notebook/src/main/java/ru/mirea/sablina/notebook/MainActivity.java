package ru.mirea.sablina.notebook;
...
import ru.mirea.sablina.notebook.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("SdCardPath") String pathh = "/data/data/ru.mirea.sablina.notebook/files/fileName.txt";
    ...
    public void onSaveText(View view) throws IOException {
        ...
        @SuppressLint("SdCardPath") String path = "/data/data/ru.mirea.sablina.notebook/files/"+fileName;
